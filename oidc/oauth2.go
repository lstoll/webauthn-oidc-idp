...
func signatureAlgorithm(jwk *jose.JSONWebKey) (alg jose.SignatureAlgorithm, err error) {
	...
	case *rsa.PrivateKey:
		...
		//
		// See https://github.com/heroku/deci/internal/issues/692
...
func (s *Server) newIDToken(clientID string, ident idp.Identity, scopes []string, nonce, accessToken string) (idToken string, expiry time.Time, err error) {
